...
* **Unabhängige Infrastruktur:** Mein primärer Quellcode, Releases und CI/CD laufen autark auf eigener Server-Hardware.

---

### 🌐 Wo du meine Projekte findest

Meine aktive Entwicklung und alle Software-Verteilungen liegen auf meiner eigenen Infrastruktur:

* 🌐 **Offizielle Web-Plattform:** [https://pi5.darter-basking.ts.net/](https://pi5.darter-basking.ts.net/)
* ☕ **Gitea Code-Repositories:** [https://pi5.darter-basking.ts.net/gitea/](https://pi5.darter-basking.ts.net/gitea/)
